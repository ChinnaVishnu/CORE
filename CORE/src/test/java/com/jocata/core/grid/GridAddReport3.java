...
public class GridAddReport3 extends mainbaseLatest {
	...
	public void GridTest() {
		...
		//try {
			...
			fluentWait(By.xpath("//table[@id='role-triggerWrap']//td[2]//div")).click();

			// fluentWait(By.xpath("//div[@id='ext-gen1652']")).click();

			fluentWait(By.xpath("//li[text()='Level1']")).click();

			sleep(8);
			fluentWait(By.xpath("//table[@id='businessUnit-triggerWrap']//td[2]//div")).click();

			fluentWait(By.xpath("//li[text()='Bank Wide']")).click();

			fluentWait(By.xpath("//table[@id='status-triggerWrap']//td[2]//div")).click();
