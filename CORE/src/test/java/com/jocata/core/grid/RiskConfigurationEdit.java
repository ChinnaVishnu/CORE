...
public class RiskConfigurationEdit extends mainbaseLatest {
	...
	public void clickriskconfigrationedit() {
		//try {
			...
			sleep(4);
			fluentWait(By.xpath("//div[@data-qtip='01:EESOD']")).click();
			sleep(4);
			fluentWait(By.xpath("//div[@data-qtip='01:O223 PREPARATION AND SPINNING OF JUTE ETC.[O223]']")).click();

			sleep(4);
			fluentWait(By.xpath("//div[@data-qtip='01:TIE-UP BUSINESS (FARMER & NON-FARMER)[016]']")).click();
			sleep(4);
