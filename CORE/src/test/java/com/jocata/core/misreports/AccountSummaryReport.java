...
public class AccountSummaryReport extends mainbaseLatest {
	...
	public void addReport() throws InterruptedException, IOException {
		...
		ExtentTestManager.startTest(" MIS Report :   Account Summary Report  ");
		...
		try {
			...
			String target = " Account Summary Report";
			...
			fluentWait(By.xpath("//input[@id='reportName']")).sendKeys("AccountSummaryReport");
			...
			ExtentTestManager.getTest().log(LogStatus.INFO, "Account Summary Report Added SucessFully");
