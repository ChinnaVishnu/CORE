...
import com.jocata.core.existingfuctions.CureentdateTime2;
...
public class AdvancedAddBenchMark2 extends mainbaseLatest {
	...
	public void clickAddbench() throws HeadlessException, AWTException, IOException {
		...
		for (WebElement all : elements) {
			...
			if (all.getAttribute("data-qtip").equals("1175")) {
		...
		try {
			...
			fluentWait(By.cssSelector(".x-boundlist:not([style*='display: none']) div ul li")).click();
			fluentWait(By.xpath("//input[@id='rulesConfValueses2thresholdValue1']")).sendKeys("12");
			fluentWait(By.xpath("//input[@id='rulesConfValueses2thresholdValue2']")).sendKeys("13");
			
			fluentWait(By.xpath("//tr[3]/td/div/div/div/span/div/table/tbody/tr/td[2]/div/span/div/div/div/ul/li/div")).click();
			
			
			fluentWait(By.xpath("//tr[4]/td/div/div/div/span/div/table/tbody/tr/td[2]/div/span/div/div/div/ul/li/div")).click();
			
			
			fluentWait(By.xpath("//input[@id='rulesConfValueses5thresholdValue1']")).sendKeys("45");
			fluentWait(By.xpath("//input[@id='rulesConfValueses5thresholdValue2']")).sendKeys("50");
			
			//..............................Account Balance
			
			fluentWait(By.xpath("//input[@id='rulesConfValueses6thresholdValue1']")).sendKeys("56");

			fluentWait(By.xpath("//input[@id='rulesConfValueses6thresholdValue2']")).sendKeys("57");
...
*/
     ...
     String today=	CureentdateTime2 .getCurrentDate();
		...
		if (createdt.equals(today)) {
			...
			ExtentTestManager.getTest().log(LogStatus.PASS,  " Benchmark not  added  ");
			ExtentTestManager.getTest().log(LogStatus.INFO, "Screenshortbelow :" + ExtentTestManager.getTest()
			.addScreenCapture(GetScreenshort.capture(driver, "ScreenshortForExtentReport")));
		}
