package com.jocata.core.screens;
...
public class ThresholdParametersRule  extends mainbaseLatest {
	...
	public void loginNew() {
		...
		ExtentTestManager.startTest("  Create New Rule : Threshold Parameters & Filters ");
	...
	public void clickDashboard(String name) {
		...
		try {
			...
			fluentWait(By.xpath("//li[text()='Bank Wide']")).click();
			...
			fluentWait(By.xpath("//input[@id='ruleName']")).sendKeys(user + raaaa);

			// clicking Desception//
			fluentWait(By.xpath("//textarea[@id='ruleDescription']")).sendKeys(" This is Testing");
			...
			fluentWait(By.xpath("//input[@id='ruleReferenceNmbr']")).sendKeys(user + raaaa);
			...
			//..................................Channel SubType...............................................................//	
              ...
              fluentWait(By.xpath("//div[3]/div/div[3]/div[3]/a")).click();
              sleep(5);
              
              fluentWait(By.xpath("//div[3]/div/div[3]/div[2]/div/table/tbody/tr[3]/td[2]/table/tbody/tr/td[2]/table/tbody/tr/td[2]/div")).click();
              
              sleep(5);
              fluentWait(By.cssSelector(".x-boundlist:not([style*='display: none']) div li:nth-of-type(2)")).click();
              sleep(5);
              
              fluentWait(By.xpath("//td[5]/div/table/tbody/tr/td[2]/table/tbody/tr/td[2]/div")).click();
              ...
              sleep(5);
              fluentWait(By.xpath("//tr[4]/td[2]/table/tbody/tr/td[2]/table/tbody/tr/td[2]/div")).click();
              sleep(5);
              fluentWait(By.cssSelector(".x-boundlist:not([style*='display: none']) div li:nth-of-type(3)")).click();
              sleep(5);
              fluentWait(By.cssSelector(".x-boundlist:not([style*='display: none']) div li:nth-of-type(2)")).click();
              sleep(5);
              fluentWait(By.xpath("//div[3]/div/div[3]/div[3]/a")).click();
              ...
              //..............................Account Age.................................................................//
              sleep(6);
              fluentWait(By.xpath("//div[3]/div/div/div/div[2]/div/table/tbody/tr[2]/td[2]/table/tbody/tr/td[2]/table/tbody/tr/td[2]/div")).click();
              sleep(6);
              fluentWait(By.xpath("//li[contains(text(),'Account Age')]")).click();
              sleep(6);
              
              fluentWait(By.xpath(".//*[@id='ruleBldrVOAccCusTransDetList[0].custAccTransDetFilterFromVal']")).sendKeys("20");
              
              sleep(6);
              fluentWait(By.xpath(".//*[@id='ruleBldrVOAccCusTransDetList[0].custAccTransDetFilterToVal']")).sendKeys("30");
              sleep(6);
              fluentWait(By.xpath("//div[3]/div/div/div/div[4]/a")).click();
              
              
              //........................Account Balance......................................................................//
              
             /* fluentWait(By.xpath("//div[3]/div/div/div/div[2]/div/table/tbody/tr[3]/td[2]/table/tbody/tr/td[2]/table/tbody/tr/td[2]/div")).click();
              fluentWait(By.cssSelector("#boundlist-1060-listEl > ul > li:nth-child(3)")).click();
              fluentWait(By.xpath(".//*[@id='ruleBldrVOAccCusTransDetList[1].custAccTransDetFilterFromVal']")).sendKeys("40");
              fluentWait(By.xpath(".//*[@id='ruleBldrVOAccCusTransDetList[1].custAccTransDetFilterToVal']")).sendKeys("30");
	...
	if(actaulnewrule.equals(excetedname)){
		...
		System.out.println("not created");
				...
				sleep(9);
				fluentWait(By.xpath("//input[@id='rulesNameCombo-inputEl']")).sendKeys(user + raaaa);
